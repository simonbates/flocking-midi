...
fluid.defaults("flock.midi.nodejs.access", {
    ...
    listeners: {
        ...
        // This is hack works around
        // https://github.com/justinlatimer/node-midi/issues/117
        // TODO: This works on OS X but needs to be tested on all platforms;
        // it's quite possible that attempting to open a port when none are
        // connected could explode elsewhere.
        "onDestroy.freeNodeMIDIResources": [
            {
                "this": "{that}.input",
                method: "openPort",
                args: [0]
